...
const config = {
  wrapper: 'relative border-b border-gray-200 dark:border-gray-800 py-4 sm:py-8',
  // container: 'flex flex-col lg:flex-row lg:items-center lg:justify-between',
  container: 'flex flex-col sm:flex-row sm:items-center sm:justify-between',
  ...
  icon: {
    wrapper: 'flex',
    base: 'w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 text-primary'
  },
  // links: 'flex flex-wrap items-center gap-1.5 mt-4 lg:mt-0'
  links: 'flex flex-wrap items-center gap-1.5 mt-4 sm:mt-0'
}
